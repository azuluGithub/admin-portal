...
import { chatData } from '../Chat/Chat.config';

const NotificationComponent = (props) => {
  const { currentColor, handleNavTab } = props;

  return (
    <div className="nav-item absolute container-shadow right-5 md:right-40 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">

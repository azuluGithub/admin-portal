...
import './NewsCreate.style.scss';

class NewsCreateComponent extends PureComponent {
    ...
    return (
      <div className='bg-white'>
        <form onSubmit={() => this.handleFormSubmit()}>
          <h2 className='text-xl p-5 text-bold mb-4 uppercase'>{'Create News'}</h2>

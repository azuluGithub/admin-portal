...
import './LecturerCreate.style.scss';

class LecturerCreateComponent extends PureComponent {
    ...
    return (
      <div className='bg-white'>
        <form onSubmit={() => this.handleFormSubmit()}>
          <h2 className='text-xl p-5 text-bold mb-4 uppercase'>{'Create Lecturer'}</h2>
  ...
  render() {
    return this.renderLecturerCreate();
  }
}

export default LecturerCreateComponent;
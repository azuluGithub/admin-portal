...
import './NewsUpdate.style.scss';

class NewsUpdateComponent extends PureComponent {
  ...
  setData() {
    ...
    if (news) {
      const { imgUrl, title, content, category, author, date } = news;
    ...
    return (
      <div className='p-10 bg-white'>
        <form onSubmit={() => this.handleFormSubmit()}>
          <h2 className='text-xl text-bold mb-4 uppercase'>{'Update News'}</h2>
          { this.renderImage() }
          { this.renderTitle() }
